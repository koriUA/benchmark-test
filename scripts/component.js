...
/* eslint-disable */
/**
 * Content UI - Component Generator
 *
 * Use this app to generate new component files:
 * index.js, _component.scss, Component.jsx, Component.test.jsx, ComponentContainer.jsx, ComponentContainer.test.jsx.
 *
...
const basicFilesNames = [
  ...
  '{BigCamel}.jsx',
  '{BigCamel}.test.jsx',
  '{BigCamel}Container.jsx',
  '{BigCamel}Container.test.jsx',
];

const basicFilesContent = {
  'index.js': `export default from './{BigCamel}';`,
  '_{kebab}.scss': `@import '~carbon-components/scss/globals/scss/vendor/@carbon/grid/scss/prefix';\n\n@mixin {kebab} {\n  .#{$prefix}--{kebab} {\n    // styles\n  }\n}\n\n@include exports('{kebab}') {\n @include {kebab};\n}`,
  ...
  '{BigCamel}Container.jsx': `import React from 'react';\nimport PropTypes from 'prop-types';\nimport { settings } from 'carbon-components';\n\nconst { prefix } = settings;\n\nconst {BigCamel} = () => {\n  return (\n    <div className={\`\${prefix}--{kebab}\`}>\n\n    </div>\n  );\n};\n\n{BigCamel}.propTypes = {};\n\n{BigCamel}.defaultProps = {};\n\nexport default {BigCamel};`,
  '{BigCamel}Container.test.jsx': `import React from 'react';\nimport { mount } from 'enzyme';\n\nimport {BigCamel} from './{BigCamel}';\n\ndescribe('{BigCamel}', () => {\n  test('it renders', () => {\n    const component = mount(<{BigCamel} />);\n    expect(component.find({BigCamel})).toHaveLength(1);\n  });\n});`,
};
